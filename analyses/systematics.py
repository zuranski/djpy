...
class systematics(supy.analysis) :
	...
	def listOfSteps(self,config) :
		...
		+[steps.event.effDenom(indices=self.AccCuts[-1]['name']+'Indices',weights=None)]	
		...
		+self.dijetSteps1()
		+[steps.event.general()]
		+[steps.event.effNum(indices=self.IniCuts[-1]['name']+'Indices',weights=None)]	
		)
