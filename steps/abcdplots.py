...
class abcd_histo(analysisStep):
	...
	def uponAcceptance(self,e):
		...
		counts = e[self.collection].counts
		self.book.fill((0,0),self.collection+'counts',(2,2),(-0.5,-0.5),(1.5,1.5),w=counts['A'],
		title=self.collection + " ; " + self.cut1 +";"+ self.cut2+"; counts",
		xAxisLabels=['False','True'],yAxisLabels=['False','True'])
		self.book.fill((1,0),self.collection+'counts',(2,2),(-0.5,-0.5),(1.5,1.5),w=counts['B'],
		title=self.collection + " ; " + self.cut1 +";"+ self.cut2+"; counts",
		xAxisLabels=['False','True'],yAxisLabels=['False','True'])
		self.book.fill((0,1),self.collection+'counts',(2,2),(-0.5,-0.5),(1.5,1.5),w=counts['C'],
		title=self.collection + " ; " + self.cut1 +";"+ self.cut2+"; counts",
		xAxisLabels=['False','True'],yAxisLabels=['False','True'])
		self.book.fill((1,1),self.collection+'counts',(2,2),(-0.5,-0.5),(1.5,1.5),w=counts['D'],
		title=self.collection + " ; " + self.cut1 +";"+ self.cut2+"; counts",
		xAxisLabels=['False','True'],yAxisLabels=['False','True'])
