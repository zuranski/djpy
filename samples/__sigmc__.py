...
# u-d-s quark samples
sigmc.add('H_1000_X_350','%s'%(fileListFromDisk(loc+"MH_1000_MX_350_Ctau_35To3500/")) ,xs=500.1) #/pb
sigmc.add('H_1000_X_150','%s'%(fileListFromDisk(loc+"MH_1000_MX_150_Ctau_10To1000/")) ,xs=500.1) #/pb
sigmc.add('H_1000_X_50','%s'%(fileListFromDisk(loc+"MH_1000_MX_50_Ctau_4To400/")) ,xs=500.1) #/pb
sigmc.add('H_1000_X_20','%s'%(fileListFromDisk(loc+"MH_1000_MX_20_Ctau_1p5To150/")) ,xs=500.1) #/pb
sigmc.add('H_400_X_150','%s'%(fileListFromDisk(loc+"MH_400_MX_150_Ctau_40To4000/")) ,xs=500.1) #/pb
