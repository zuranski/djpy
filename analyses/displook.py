...
class displook(supy.analysis) :
    ...
    def listOfSteps(self,config) :
	    ...
	    steps.plotjets.general("dispPfJets"),
	    steps.plotjets.fractions("dispPfJets"),
	    steps.plotjets.tracks("dispPfJets"),
	    steps.plotjets.vertices("dispPfJets"),
	    steps.plotjets.disptracks("dispPfJets"),
	    steps.plotjets.general("dispPfJetPairs"),
	    steps.plotjets.fractions("dispPfJetPairs"),
	    steps.plotjets.tracks("dispPfJetPairs"),
	    steps.plotjets.vertices("dispPfJetPairs"),
	    steps.plotjets.disptracks("dispPfJetPairs"),
            ]
