...
class general(analysisStep):
	def uponAcceptance(self,e): 
		...
		self.book.fill(e['nCaloJets'],'nCaloJets',16,0,15,None,title='nCaloJets ; nCaloJets ; events / bin')
		self.book.fill(e['nPfJets'],'nPfJets',16,0,15,None,title='nPfJets ; nPfJets ; events / bin')
