...
sigmc.add('Huds_1000_X_20','%s'%(fileListFromDisk(loc+"MH_1000_MX_20_Ctau_15/")) ,xs=500) #/pb
...
sigmc.add('Huds_400_X_20','%s'%(fileListFromDisk(loc+"MH_400_MX_20_Ctau_40/")) ,xs=500) #/pb
sigmc.add('Huds_200_X_50','%s'%(fileListFromDisk(loc+"MH_200_MX_50_Ctau_200/")) ,xs=500) #/pb
sigmc.add('Huds_200_X_20','%s'%(fileListFromDisk(loc+"MH_200_MX_20_Ctau_70/")) ,xs=500) #/pb
sigmc.add('Huds_120_X_50','%s'%(fileListFromDisk(loc+"MH_120_MX_50_Ctau_500/")) ,xs=500) #/pb
sigmc.add('Huds_120_X_20','%s'%(fileListFromDisk(loc+"MH_120_MX_20_Ctau_130/")) ,xs=500) #/pb
...
sigmc.add('Hb_1000_X_20','%s'%(fileListFromDisk(loc+"MH_1000_MX_20_Ctau_15b/")) ,xs=500) #/pb
...
sigmc.add('Hb_400_X_20','%s'%(fileListFromDisk(loc+"MH_400_MX_20_Ctau_40b/")) ,xs=500) #/pb
sigmc.add('Hb_200_X_50','%s'%(fileListFromDisk(loc+"MH_200_MX_50_Ctau_200b/")) ,xs=500) #/pb
sigmc.add('Hb_200_X_20','%s'%(fileListFromDisk(loc+"MH_200_MX_20_Ctau_70b/")) ,xs=500) #/pb
sigmc.add('Hb_120_X_50','%s'%(fileListFromDisk(loc+"MH_120_MX_50_Ctau_500b/")) ,xs=500) #/pb
sigmc.add('Hb_120_X_20','%s'%(fileListFromDisk(loc+"MH_120_MX_20_Ctau_130b/")) ,xs=500) #/pb
