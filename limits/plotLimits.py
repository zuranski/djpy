...
def limitPlot(MH = None,MX = None,observed=False):
	c=r.TCanvas()
	...
	for i,obj in enumerate(list):
		g[0].SetPoint(i,obj['ctau'],obj['obs'])
		g[1].SetPoint(i,obj['ctau'],obj['exp'])
		g[2].SetPoint(i,obj['ctau'],obj['p1s'])
		g[2].SetPoint(2*n-1-i,obj['ctau'],obj['m1s'])
		g[3].SetPoint(i,obj['ctau'],obj['m2s'])
		g[3].SetPoint(2*n-1-i,obj['ctau'],obj['p2s'])
