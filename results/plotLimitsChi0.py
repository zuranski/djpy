...
def limitPlot(MH = None,MX = None,list = None,observed=False):
	...
	f1.Draw('Lsame')
	f2.Draw('Lsame')
	mg.GetXaxis().SetTitle('#chi^{0} c#tau [cm]')
	...
	#leg=r.TLegend(0.23,0.65,0.6,0.82)
	leg=r.TLegend(0.23,0.45,0.6,0.62)
	leg.SetFillColor(0)
	#leg2=r.TLegend(0.62,0.71,0.85,0.82)
	...
	leg.AddEntry(f,'#sigma_{#tilde{q}#bar{#tilde{q}}+#tilde{q}#tilde{q}} (NLO-NLL) \\pm 1\\sigma_{theory}','L')
